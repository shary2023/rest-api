...
public class InsuranceItemSchema {
  ...
  */
  ...
  @Schema(name = "brand", example = "sony", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  */
  ...
  @Schema(name = "model", example = "ps5", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  */
  ...
  @Schema(name = "number", example = "15", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
