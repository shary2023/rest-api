...
public class InsuranceCreationResponseSchema implements GetLease200Response {
  ...
  @JsonProperty("owner")
  private InsuranceOwnerSchema owner;

  @JsonProperty("renter")
  private InsuranceRenterSchema renter;
  ...
  */
  ...
  public InsuranceCreationResponseSchema endsAt(String endsAt) {
    this.endsAt = endsAt;
    return this;
  }
  ...
  */
  ...
  public InsuranceCreationResponseSchema startsAt(String startsAt) {
  ...
  */
  ...
  public InsuranceCreationResponseSchema owner(InsuranceOwnerSchema owner) {
    this.owner = owner;
    return this;
  }
  ...
  */
  ...
  public InsuranceOwnerSchema getOwner() {
    return owner;
  }

  public void setOwner(InsuranceOwnerSchema owner) {
    this.owner = owner;
  }

  public InsuranceCreationResponseSchema renter(InsuranceRenterSchema renter) {
    this.renter = renter;
    return this;
  }
  ...
  */
  ...
  public InsuranceRenterSchema getRenter() {
    return renter;
  }

  public void setRenter(InsuranceRenterSchema renter) {
    this.renter = renter;
  }
