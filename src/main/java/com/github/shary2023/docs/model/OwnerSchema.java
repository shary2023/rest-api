...
public class OwnerSchema {
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, email, firstName, secondName, inn, birthday, passportNumber, passportSeries, phoneNumber, registrationAddress, residenceAddress, telegramId, chatId);
  }
