...
public class UserSchema {
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, password, birthday, registrationAddress, residenceAddress, isAddressesMatch, isAgreeWithPublicOffer, isAgreeWithFullDeposit, isDishonestClient, isValid, owner, renter, telegramId, chatId, email, inn, phoneNumber, passportNumber, passportSeries, firstName, secondName, givenName);
  }
